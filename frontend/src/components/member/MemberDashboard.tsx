    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-ko-500/10 border border-ko-500/20">
          ...
          <span className="bg-gradient-to-r from-ko-500 to-ko-600 bg-clip-text text-transparent text-sm font-medium">Member since {member.joinDate.getFullYear()}</span>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 p-6 rounded-xl bg-card/50 border border-border">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="bg-gradient-to-r from-ko-500 to-ko-600 bg-clip-text text-transparent">75%</span>
                  </div>
            ...
            <div className="sm:w-48 p-4 rounded-lg bg-ko-500/10 border border-ko-500/20">
              ...
              <p className="font-display text-4xl font-bold bg-gradient-to-r from-ko-500 to-ko-600 bg-clip-text text-transparent">{daysUntilExpiry}</p>
